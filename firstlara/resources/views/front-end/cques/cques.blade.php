                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Transportation and Highway Engineerin</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Water Supply and Sanitation Engineering</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Project planning and Construction</h3>
                                            <p>
