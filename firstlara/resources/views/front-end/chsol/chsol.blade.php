                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Basic Electrical Engineering</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Industrial Stoichiometry</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse2' aria-expanded='true' aria-controls='collapse0'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a href="">
                                            <h3>Corrosion and Materials of Construction</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse5' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Energy and Environment</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Fertilizer Technology and Pulp and paper</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Natural gas and Refinery Engineering</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Food and Sugar Technology</h3>
                                            <p>
                            ...
                            <h4 class='panel-title'>
                                   <a class='collapsed' role='button' data-toggle='collapse' data-parent='#accordion' href='#collapse7' aria-expanded='false' aria-controls='collapse'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-8'>
                                            <a><h3>Polymer materials and Technology</h3>
                                            <p>
